...
$c->setOptions(array('login_path' => 'security_login', 'default_target_path' => 'articles', 'always_use_default_target_path' => true, 'use_referer' => true, 'target_path_parameter' => '_target_path'));
...
$d->setOptions(array('login_path' => 'security_login', 'failure_path' => 'security_login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

...
// Returns the private 'App\Repository\WidgetRepository' shared autowired service.
...
return $this->privates['App\Repository\WidgetRepository'] = new \App\Repository\WidgetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
